...
public class Controller {
    ...
    private int canvasLength = 2000; //Размер холста в колонке
    private int CanvasWidth = 168; //Размер холста в колонке
    int spaceFont = 10; //Отступ между строками при выводе данных
    int fontSize = 30; //Размер шрифта для рисования
    int isFinished;
