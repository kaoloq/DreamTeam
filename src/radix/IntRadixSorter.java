...
public class IntRadixSorter extends RadixSorter {
    ...
    public int doStep() {
        ...
        if (!m_workingArray.isEmpty()) {
            ...
            System.out.println("Working array is empty: gluing all the elements together!");
            controller.printToTextArea("Working array is empty: gluing all the elements together!");
